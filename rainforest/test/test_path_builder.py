...
class TestPathBuilder(unittest.TestCase):
    class FakeResource(rainforest.apibits.ApiResource):
        _api_attributes = {'abc': ''}
        def __init__(self):
    ...
    def test_object_attributes(self):
        ...
        actual = rainforest.apibits.PathBuilder.build(self.object, None, path)
    ...
    def test_param_values(self):
        ...
        actual = rainforest.apibits.PathBuilder.build(None, self.params, path)
        self.assertEqual(expected, actual)
    ...
    def test_attributes_and_params(self):
        ...
        actual = rainforest.apibits.PathBuilder.build(self.object, self.params, path)
        self.assertEqual(expected, actual)
